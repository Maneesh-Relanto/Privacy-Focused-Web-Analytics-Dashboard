...
export default function Settings() {
  ...
  const verifyTracking = () => {
    ...
    setTimeout(() => {
      ...
      alert('✅ Tracking verified! Events are being collected from your website.');
    }, 500);
  };
    ...
    <div className="flex-1 overflow-auto bg-background">
      <div className="p-6 max-w-6xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Configure your website analytics and tracking</p>
        </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">Display name for your website</p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">Your website's domain name</p>
                </div>
        ...
        {activeTab === 'tracking' && (
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Use this code to identify your website in the tracking script. Keep it secret!
                </p>
                ...
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                  <div className="flex gap-2">
                    ...
                    <div className="text-sm text-blue-800 dark:text-blue-200">
                      <p className="font-semibold mb-1">Keep Your Code Secure</p>
                      <p>Only use this code in your own websites. Anyone with this code can send events for your website.</p>
                    </div>
                  </div>
                </div>

                <div className="flex gap-2">
                  <Button variant="outline" onClick={verifyTracking} className="flex-1">
                  ...
                  <div key={index} className="border border-border rounded-lg overflow-hidden">
                    <div className="bg-muted p-4 border-b border-border">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground mt-2">Best for: {method.suitable}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-4">
                      <div className="bg-slate-900 text-slate-100 p-4 rounded-lg font-mono text-sm overflow-x-auto mb-4">
                        <pre className="whitespace-pre-wrap break-words">{method.code}</pre>
                      </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  After installing the tracking code, use these tools to verify it's working:
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  >
                    ...
                    <span className="text-xs text-muted-foreground mt-1">Send test events</span>
                  ...
                  >
                    ...
                    <span className="text-xs text-muted-foreground mt-1">View real metrics</span>
                    <ExternalLink className="h-4 w-4 mt-2 text-muted-foreground" />
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs text-muted-foreground mt-1">Automated tests</span>
                    <ExternalLink className="h-4 w-4 mt-2 text-muted-foreground" />
                  </a>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">Remove the last octet of visitor IP addresses</p>
                    </div>
                    <Switch
                      checked={privacySettings.anonymizeIp}
                      onCheckedChange={(checked) =>
                        setPrivacySettings({ ...privacySettings, anonymizeIp: checked })
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">Only track after user consent is given</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">Follow GDPR best practices automatically</p>
                    </div>
                    <Switch
                      checked={privacySettings.gdprCompliant}
                      onCheckedChange={(checked) =>
                        setPrivacySettings({ ...privacySettings, gdprCompliant: checked })
                      }
                    />
                  </div>

                  <div className="p-4 border border-border rounded-lg">
                    <label className="block font-semibold mb-3">Data Retention Policy</label>
                    <select
                ...
                <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                  <p className="text-sm text-green-800 dark:text-green-200">
                    <strong>✅ Privacy First:</strong> PrivacyMetrics collects no personal data by default. We don't use cookies or track individuals across sites.
                  </p>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mt-1">How PrivacyMetrics meets GDPR requirements</p>
                </a>
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mt-1">Update your website's privacy policy</p>
                </a>
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mt-1">Add cookie consent to your website</p>
                </a>
              </CardContent>
            </Card>
          </div>
        ...
        {activeTab === 'api' && (
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  API keys allow you to access PrivacyMetrics data programmatically. Keep them secret!
                </p>
                  ...
                  <div className="p-4 border border-border rounded-lg">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Created automatically</p>
                      </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mt-1">Node.js, Python, Ruby examples</p>
                </a>
