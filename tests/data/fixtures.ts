...
export const generateTestData = {
  ...
  randomPageview: () => testPageviews[Math.floor(Math.random() * testPageviews.length)],

  randomClick: () => testClickEvents[Math.floor(Math.random() * testClickEvents.length)],

  randomCustom: () => testCustomEvents[Math.floor(Math.random() * testCustomEvents.length)],

  randomDevice: () => testDevices[Math.floor(Math.random() * testDevices.length)],

  randomLocation: () => testLocations[Math.floor(Math.random() * testLocations.length)],

  randomReferrer: () => testReferrers[Math.floor(Math.random() * testReferrers.length)],
